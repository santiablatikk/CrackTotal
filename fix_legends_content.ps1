# Script para corregir caracteres corruptos restantes en blog-detail-legends.html
$file = "blog-detail-legends.html"

Write-Host "Corrigiendo caracteres corruptos restantes en $file..." -ForegroundColor Yellow

# Leer contenido
$content = Get-Content $file -Raw -Encoding UTF8

# Correcciones específicas para caracteres corruptos restantes
...
Write-Host "Caracteres corruptos corregidos exitosamente" -ForegroundColor Green 
$file = "blog-detail-legends.html"
