...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Alias de aceptación (PSG/España/etc.) — la respuesta canónica del JSON sigue la regla de letra
    const ANSWER_ALIASES = {
        'paris saint-germain': ['psg', 'paris sg', 'paris saint germain'],
        'paris saint germain': ['psg', 'paris sg', 'paris saint-germain'],
        'psg': ['paris saint-germain', 'paris saint germain'],
        'espana': ['spain', 'seleccion espanola', 'la roja'],
        'dembele': ['ousmane dembele', 'ousmane'],
        ...
        'bayern munich': ['bayern', 'bayern munchen', 'bayern de munich'],
        'bayern munchen': ['bayern', 'bayern munich', 'bayern de munich'],
        'modric': ['luka modric'],
        'emiliano martinez': ['dibu martinez', 'dibu', 'martinez'],
        'lisandro martinez': ['licha martinez', 'licha'],
        'vinicius': ['vinicius junior', 'vinicius jr', 'vini jr', 'vini'],
        'vinicius junior': ['vinicius', 'vinicius jr', 'vini jr', 'vini'],
        'gremio': ['gremio de porto alegre', 'gremio fbpa'],
        'pique': ['gerard pique'],
        'ozil': ['mesut ozil'],
        'puskas': ['ferenc puskas'],
        'eder militao': ['militao', 'eder'],
        'ruben dias': ['dias', 'ruben'],
        'joao felix': ['felix', 'joao'],
        'vitinha': ['vitor machado ferreira', 'vitor ferreira'],
        'guardiola': ['pep guardiola', 'pep'],
        'ancelotti': ['carlo ancelotti', 'carlo'],
        'slot': ['arne slot'],
        'arne slot': ['slot'],
        'kane': ['harry kane'],
        ...
        'messi': ['lionel messi', 'leo messi', 'leo'],
        'neymar': ['neymar jr', 'neymar junior'],
        'falcao': ['radamel falcao', 'el tigre'],
        'riquelme': ['juan roman riquelme', 'roman riquelme'],
        'juan roman riquelme': ['riquelme', 'roman riquelme', 'el roman'],
        'de bruyne': ['kevin de bruyne', 'kdb', 'kevin'],
        'kevin de bruyne': ['de bruyne', 'kdb'],
        'van dijk': ['virgil van dijk', 'virgil', 'vvd'],
        'virgil van dijk': ['van dijk', 'virgil', 'vvd'],
        'fortaleza': ['fortaleza ec', 'leao do pici'],
        'palmeiras': ['verdao', 'sep'],
        'botafogo': ['fogao'],
        'conmebol': ['confederacion sudamericana'],
        'uefa': ['union de asociaciones europeas de futbol'],
        'fifa': ['federacion internacional de futbol'],
        'balon de oro': ['ballon dor', 'ballon d or'],
        'champions league': ['champions', 'uefa champions league', 'ucl'],
        'conference league': ['uefa conference league', 'europa conference league'],
        'europa league': ['uefa europa league'],
        'nations league': ['uefa nations league'],
        'uefa nations league': ['nations league'],
        'liga profesional': ['liga profesional de futbol', 'lpf'],
        'la bombonera': ['bombonera', 'alberto j armando'],
        'monumental': ['el monumental'],
        'santiago bernabeu': ['bernabeu'],
        'san siro': ['giuseppe meazza'],
        'inter': ['inter de milan', 'internazionale'],
        'milan': ['ac milan', 'rossoneri'],
        'inter miami': ['inter de miami', 'miami'],
        'aston villa': ['villa'],
        'manchester city': ['city', 'man city'],
        'manchester united': ['united', 'man united', 'man utd'],
        'real madrid': ['madrid', 'el madrid'],
        'borussia dortmund': ['dortmund', 'bvb'],
        'estudiantes de la plata': ['estudiantes', 'el pincha'],
        'boca juniors': ['boca', 'xeneize'],
        'river plate': ['river', 'el millonario'],
        'racing club': ['racing', 'la academia'],
        'san lorenzo': ['el ciclon', 'cuervo'],
        'independiente': ['el rojo'],
        'velez sarsfield': ['velez', 'el fortin'],
        'ferran torres': ['torres', 'ferran'],
        'torres': ['ferran torres', 'ferran'],
        'saka': ['bukayo saka'],
        'alexis': ['alexis sanchez'],
        'olympique de marsella': ['marsella', 'om', 'olympique marsella'],
        ...
        'xolos de tijuana': ['tijuana', 'xolos', 'club tijuana'],
        'estadio da luz': ['da luz', 'luz', 'estadio de la luz'],
        'parma': ['parma calcio', 'parma fc'],
        'southampton': ['saints', 'southampton fc'],
        'quintero': ['juan fernando quintero', 'juanfer', 'juanfer quintero'],
        'yashin': ['lev yashin'],
        'young': ['ashley young'],
        'penarol': ['carbonero', 'manyas'],
        'rodri': ['rodrigo hernandez', 'rodrigo'],
